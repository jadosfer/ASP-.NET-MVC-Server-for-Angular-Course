...
namespace MvcTaskManager.Services
{
    public class UsersService : IUsersService
    {
        ...
        public UsersService(ApplicationUserManager applicationUserManager, ApplicationSignInManager applicationSignInManager, 
            IOptions<AppSettings> appSettings, ApplicationDbContext db, ApplicationRoleManager applicationRoleManager)
        {
            this._applicationUserManager = applicationUserManager;
            this._applicationSignInManager = applicationSignInManager;
            this._appSettings = appSettings.Value;
            this._db = db;
            this._applicationRoleManager = applicationRoleManager;
        }
